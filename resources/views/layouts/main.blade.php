...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
        ...
        <div id="wrapper">
            <header>
                ...
                <section id="action-bar">
                    ...
                    <div id="search-form">
                        {{ Form::open(array('url'=>'store/products/search', 'method'=>'get')) }}
                    ...
                    <div id="view-cart">
                        <a href="/store/cart/items">{{ HTML::image('img/blue-cart.gif', 'View Cart') }} View Cart</a>
                    </div><!-- end view-cart -->
            ...
            <footer>
                ...
                <section id="links">
                    <div id="my-account">
                        ...
                        <ul>
                            <li>{{ HTML::link('users/signin', 'Sign In') }}</li>
                            <li>{{ HTML::link('users/newaccount', 'Sign Up') }}</li>
                            <li><a href="/store/cart/items">Shopping Cart</a></li>
                        </ul>
                    </div><!-- end my-account -->
                    <div id="info">
                        <h4>INFORMATION</h4>
                ...
                <section class="clearfix">
                    <div id="copyright">
                        ...
                        <p id="store-copy"> eCommerce. Theme designed by Adi Purdila.</p>
                    </div><!-- end copyright -->
                    <div id="connect">
        ...
        <script>window.jQuery || document.write("{{ url('js/vendor/jquery-1.9.1.min.js') }}")</script>
